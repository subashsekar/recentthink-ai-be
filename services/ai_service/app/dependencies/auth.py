"""JWT authentication dependencies for the AI Service."""
...
class AuthenticatedUser:
    """Lightweight authenticated user from JWT claims."""
...
def get_current_user(
    ...
    """Validate JWT and return authenticated user claims."""
...
def can_access_session(user: AuthenticatedUser, owner_id: UUID) -> bool:
    """Return ``True`` when the user may access a session."""
